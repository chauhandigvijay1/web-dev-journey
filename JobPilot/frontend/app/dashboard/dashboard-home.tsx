...
import { Briefcase, Sparkles, ListTodo, Plus, ArrowRight } from "lucide-react";
        ...
        <Card className="flex flex-col justify-between border-border/60 bg-card/50 shadow-sm transition-colors hover:bg-card/80">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Let our AI find the best jobs tailored to your resume.
            </p>
            <Button variant="link" className="mt-4 h-auto p-0 text-amber-500 hover:text-amber-600" asChild>
              <Link href="/dashboard/auto-hunter" className="flex items-center gap-1">
