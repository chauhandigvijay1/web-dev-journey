    ...
    <div className="fixed inset-0 z-40 bg-zinc-900/50 p-4" onClick={handleClose} role="presentation">
      ...
      >
        ...
        <div className="mt-5 flex justify-end gap-2">
          ...
          <button
            className="rounded-xl bg-brand-500 px-4 py-2 text-sm font-medium text-white shadow-[0_0_15px_rgba(16,185,129,0.3)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_25px_rgba(16,185,129,0.5)] disabled:opacity-60"
