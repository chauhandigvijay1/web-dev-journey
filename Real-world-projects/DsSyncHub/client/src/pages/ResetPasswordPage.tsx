  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-6xl items-center px-6 py-12">
      <section className="grid w-full max-w-5xl gap-8 rounded-[32px] border border-white/10 glass-card p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 md:grid-cols-[0.95fr,1.05fr] md:p-10">
        ...
        <p className="inline-flex items-center gap-2 rounded-full border border-white/15 glass-card/10 px-3 py-1 text-xs uppercase tracking-[0.24em] text-amber-100">
          <KeyRound size={14} />
          Secure reset
        </p>
        ...
        <div className="mt-8 rounded-[24px] border border-white/10 glass-card/5 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-zinc-300">Strength checklist</p>
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <p className="text-sm text-zinc-400">
            Need a fresh link?{' '}
            <Link className="font-medium text-brand-500 hover:text-brand-400" to="/forgot-password">
